...
bot_token = os.environ.get("TOKEN", "6330264149:AAFmzFjeDPo3Qa9KLDWhahr9hbY8BjtlRmo")
...
async def start(event):
    ...
    if not event.is_private:
        return await event.respond("ɪ ᴀᴍ ᴀʟɪᴠᴇ ⋆ꏠ⋆ ᴊᴏᴍོʙʟᴏ ᴍᴜsɪᴄ ⋆ꏠ⋆")
    await event.reply(
        "━━━━━━━━━━━━━━━━━━━━━━━━\n\n✪ ɪ ᴀᴍ ⋆ꏠ⋆ ᴊᴏᴍོʙʟᴏ ᴍᴜsɪᴄ ⋆ꏠ⋆ ᴛʜᴇ ɢʀᴏᴜᴘ ᴍᴇᴍʙᴇʀs ɪɴ ᴛᴇʟᴇɢʀᴀᴍ\n✪ ᴛʜᴀɴᴋs ғᴏʀ ᴜsɪɴɢ ʀᴜɴ /help..\n\n┏━━━━━━━━━━━━━━━━━┓\n┣★ ᴏᴡɴᴇʀ    : [ʙ̷ᴧɴɢ ꝛᴀ̷ᴅεɴ](https://t.me/Radenihboss)\n┣★ ᴜᴘᴅᴀᴛᴇs › : [ᴊᴏᴍʙʟᴏ ʜᴇʟᴘ](t.me/Jomblosuport)┓\n┣★ ʀᴇᴘᴏ › : [ᴊᴏᴍʙʟᴏ ʀᴇᴘᴏ](https://github.com/Radenihbos/Jomblotagall)\n┗━━━━━━━━━━━━━━━━━┛\n\n💞 ɪғ ʏᴏᴜ ʜᴀᴠᴇ ᴀɴʏ ǫᴜᴇsᴛɪᴏɴs ᴛʜᴇɴ\nᴅᴍ ᴛᴏ ᴍʏ [ᴏᴡɴᴇʀ](https://t.me/Radenihboss) ...\n\n━━━━━━━━━━━━━━━━━━━━━━━━",
        link_preview=False,
        buttons=(
            [
                Button.url(
            ...
            [
                Button.url("☀︎︎ ɢʀᴏᴜᴘ ☀︎︎︎", "https://t.me/Jomblosuport"),
                Button.url("☀︎︎ ᴄʜᴀɴɴᴇʟ ☀︎︎", "https://t.me/Jombloday"),
            ],
            [
...
async def help(event):
    ...
    if not event.is_private:
        return await event.respond("ᴅᴇᴀʀ sᴛᴀʀᴛ ᴍᴇ ɪɴ ᴘᴍ ᴛᴏ ᴜsᴇ ᴛʜɪs ᴄᴏᴍᴍᴀɴғ 🥺")
    helptext = "✪ ᴏᴡɴᴇʀ ᴍᴇɴᴜ ᴏғ ᴊᴏᴍʙʟᴏ ᴍᴇɴᴛɪᴏɴ\n\n✪ ᴍʏ ᴏᴡɴᴇʀ ɪs [ʙ̷ᴧɴɢ ꝛᴀ̷ᴅεɴ](https://t.me/Radenihboss)\n✪ ᴏғғɪᴄɪᴀʟ ᴍᴇᴍʙᴇʀ ᴏғ ᴀɪʀᴅʀᴏᴘ\n✪ ʏᴏᴜᴛᴜʙᴇ [ᴄʜᴀɴɴᴇʟ](https://youtube.com/channel/UCLZMrrb0C4F63WdD82VQrGw)\n✪ ғᴜᴛᴜʀᴇ ᴀɴᴇsᴛʜᴇᴛɪᴄ."
    await event.reply(
        helptext,
        link_preview=False,
        buttons=(
